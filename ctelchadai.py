...
#Também cria o cadastro do usuário
        ...
        try:
            ...
            for i in self.cursor.fetchall():                
                if cpf == cryptocode.decrypt(i[1], chaveCriptografia):                    
                    ...
                    f.write(bytes)
                    f.close()
                    listaPdf.append('receita de '+cryptocode.decrypt(i[3], chaveCriptografia)+' para '+nome +'.pdf')
            ...
            rel.save()            
            listaPdf.append('medicamentos.pdf')
    ...
    def gerarPdfRegistros(self):
        ...
        try:
            ...
            rel.save()
            listaPdf.append('ocorrencias.pdf')
